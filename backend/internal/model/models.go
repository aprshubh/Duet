...
const (
	...
	EventReaction           = "ROOM_REACTION"
	EventVideoURL           = "VIDEO_URL_CHANGE"
	EventVoiceSignal        = "VOICE_SIGNAL"
	EventVoiceState         = "VOICE_STATE"
	EventError              = "ERROR"
)

// ReactionPayload represents an animated emoji reaction
...
// VideoURLPayload represents a video/YouTube stream change
type VideoURLPayload struct {
	URL        string `json:"url"`
	SourceType string `json:"sourceType"` // "youtube" | "direct" | "file"
	Title      string `json:"title,omitempty"`
}

// VoiceSignalPayload represents WebRTC signaling (SDP offer/answer/ICE candidate)
...
// VoiceStatePayload represents voice room presence and mute state
